...
class UNET_TR(nn.Module):
    ...
    def forward(self, inputs):                      # 2x  3 x 128 x 128
        ...
        # plt.figure()
        # plt.subplot(2,5,1)    
        # plt.imshow(z0[0,0].detach().numpy(),cmap='gray')
        # plt.subplot(2,5,2)
        # plt.imshow(z3[0,0].detach().numpy(),cmap='gray')
        # plt.subplot(2,5,3)
        # plt.imshow(z6[0,0].detach().numpy(),cmap='gray')
        # plt.subplot(2,5,4)
        # plt.imshow(z9[0,0].detach().numpy(),cmap='gray')
        # plt.subplot(2,5,5)
        # plt.imshow(z12[0,0].detach().numpy(),cmap='gray')
